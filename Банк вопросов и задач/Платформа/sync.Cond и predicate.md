...
# sync.Cond и predicate

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/12 Примитивы синхронизации#Урок 92. `sync.Cond`]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/12 Примитивы синхронизации#Урок 92. `sync.Cond`|Урок 92. `sync.Cond`]] — канонический проверенный разбор.
- [[CurseHunter/7147/Бланк вопросов и заданий#6. `sync.Cond`: ждать нужно predicate|6. `sync.Cond`: ждать нужно predicate]] — вариант или дополнительное появление.
