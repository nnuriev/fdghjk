...
# Data race и WaitGroup

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/12 Примитивы синхронизации#Урок 84. Data race и race condition]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/12 Примитивы синхронизации#Урок 84. Data race и race condition|Урок 84. Data race и race condition]] — канонический проверенный разбор.
- [[CurseHunter/7147/Бланк вопросов и заданий#1. Safety: data race и логическая гонка|1. Safety: data race и логическая гонка]] — вариант или дополнительное появление.
