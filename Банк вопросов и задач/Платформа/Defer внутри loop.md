...
![[CurseHunter/6609/07 Defer#Урок 53. `defer` внутри loop]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/07 Defer#Урок 53. `defer` внутри loop|Урок 53. `defer` внутри loop]] — канонический проверенный разбор.
