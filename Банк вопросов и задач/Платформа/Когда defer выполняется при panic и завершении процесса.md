---
aliases:
  - "Задача: Когда defer выполняется при panic и завершении процесса"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Когда defer выполняется при panic и завершении процесса

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/08 Ошибки и panic#Урок 65. Когда defers выполняются]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/08 Ошибки и panic#Урок 65. Когда defers выполняются|Урок 65. Когда defers выполняются]] — канонический проверенный разбор.
