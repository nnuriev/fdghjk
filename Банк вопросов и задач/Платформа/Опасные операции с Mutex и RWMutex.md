---
aliases:
  - "Задача: Опасные операции с Mutex и RWMutex"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Опасные операции с Mutex и RWMutex

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/12 Примитивы синхронизации#Урок 89. Опасные операции с Mutex/RWMutex]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/12 Примитивы синхронизации#Урок 89. Опасные операции с Mutex/RWMutex|Урок 89. Опасные операции с Mutex/RWMutex]] — канонический проверенный разбор.
