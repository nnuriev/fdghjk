---
aliases:
  - "Задача: Busy-wait deadlock и livelock"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Busy-wait deadlock и livelock

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/12 Примитивы синхронизации#Урок 86. «Livelock»]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/12 Примитивы синхронизации#Урок 86. «Livelock»|Урок 86. «Livelock»]] — канонический проверенный разбор.
