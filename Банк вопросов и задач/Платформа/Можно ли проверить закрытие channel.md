---
aliases:
  - "Задача: Можно ли проверить закрытие channel"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Можно ли проверить закрытие channel

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/13 Каналы#Урок 102. Можно ли проверить, закрыт ли channel]]

## Варианты формулировки и происхождение

- [[CurseHunter/6593/03 Каналы, время и паттерны#Как проверить, закрыт ли channel?|Как проверить, закрыт ли channel?]] — дополнительное появление вопроса о destructive/stale `IsClosed`.
- [[CurseHunter/6609/13 Каналы#Урок 102. Можно ли проверить, закрыт ли channel|Урок 102. Можно ли проверить, закрыт ли channel]] — канонический проверенный разбор.
