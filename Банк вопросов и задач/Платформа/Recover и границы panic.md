---
aliases:
  - "Задача: Recover и границы panic"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Recover и границы panic

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/08 Ошибки и panic#Урок 66. Тонкости `recover`]]

## Варианты формулировки и происхождение

- [[CurseHunter/6609/08 Ошибки и panic#Урок 66. Тонкости `recover`|Урок 66. Тонкости `recover`]] — канонический проверенный разбор.
