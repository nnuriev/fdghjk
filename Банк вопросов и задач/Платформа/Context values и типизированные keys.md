---
aliases:
  - "Задача: Context values и типизированные keys"
tags:
  - область/go
  - тема/собеседование
  - тип/задача
...
# Context values и типизированные keys

## Каноническая формулировка, контракт и проверенный разбор

![[CurseHunter/6609/14 Контексты#Урок 109. `WithValue`]]

## Варианты формулировки и происхождение

- [[CurseHunter/6593/04 Context и модель памяти#`WithValue`|`WithValue`]] — вопрос о request-scoped metadata, typed keys и запрете option bags.
- [[CurseHunter/6609/14 Контексты#Урок 109. `WithValue`|Урок 109. `WithValue`]] — канонический проверенный разбор.
